...
public class SwiftMainActivityBinding_ListenerProxy implements com.johnholdsworth.swiftbindings.SwiftMainActivityBinding.Listener {

    // address of proxy object
    long __swiftObject;

    SwiftMainActivityBinding_ListenerProxy( long __swiftObject ) {
